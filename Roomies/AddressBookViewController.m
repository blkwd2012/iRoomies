...
- (BOOL)peoplePickerNavigationController:(ABPeoplePickerNavigationController *)peoplePicker shouldContinueAfterSelectingPerson:(ABRecordRef)person
{
	...
	NSLog(@"email: %@", (NSString *) ABMultiValueCopyValueAtIndex(multi_email, 0));
	
	NSLog(@">>>>>>>>>>>>>>ADDRESS parentViewController222 %p", inviteViewController);
	[inviteViewController setChoice:fullName: (NSString *) ABMultiValueCopyValueAtIndex(multi_name, 0): (NSString *) ABMultiValueCopyValueAtIndex(multi_email, 0)];
